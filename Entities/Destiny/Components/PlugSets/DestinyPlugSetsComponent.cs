...
namespace BungieNetApi.Entities.Destiny.Components.PlugSets
{
	/// <summary>
	...
	/// </summary>
	public struct DestinyPlugSetsComponent
	{
		/// <summary>
		/// The shared list of plugs for each relevant PlugSet, keyed by the hash identifier of the PlugSet (DestinyPlugSetDefinition).
		/// </summary>
		/// <remarks>Mapped to Destiny.Definitions.Sockets.DestinyPlugSetDefinition</remarks>
		[JsonPropertyName("plugs")]
		public Dictionary<uint, object[]> Plugs { get; set; }
